...
import { Rocket,Code, Code2, Fullscreen, Monitor, Send, X, MessagesSquare } from 'lucide-react';
    ...
    <div className='h-screen w-screen flex bg-black text-white overflow-hidden'>
            ...
            <>
             <div className='flex-1 overflow-y-auto px-4 py-4 space-y-4'>
                ...
                <div className='max-w-[85%] mr-auto'>
                      <div className='px-4 py-2.5 rounded-2xl text-xs bg-white/5 border border-white/10 text-zinc-400 italic'>{thinkingSteps[thinkingIndex]}
                      </div>  
                </div>}
                ...
                <div className='p-3 border-t border-white/10'>
                    <div className='flex gap-2'>
                        ...
                        <button className='px-4 py-3 rounded-2xl bg-white text-black ' onClick={handleUpdate} disabled={updateLoading}><Send size={14}/></button>
                    </div>
                </div>
        </>
        </aside>
        ...
        <div className='flex-1 flex flex-col'>
            ...
            <div className='flex gap-2'>
                ...
                <button className='p-2 lg:hidden' onClick={()=>setshowChat(true)}><MessagesSquare size={18}/></button>
        ...
        <AnimatePresence>
            {showFullPreview && (
                ...
                >
                    ...
                    <button onClick={()=>setshowFullPreview(false)} className='absolute top-4 right-4 p-2 '><X/></button>
                </motion.div>
            )}
        </AnimatePresence>
