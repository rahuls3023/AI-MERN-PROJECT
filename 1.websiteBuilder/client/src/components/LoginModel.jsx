...
function LoginModel({open,onClose}){
    ...
    const googleAuthenticator=async()=>{
        try {
    ...
    {open && 
            ...
            >
                ...
                >
                    ...
                    <button
                    className='absolute top-5 right-5 z-20 text-zinc-500 hover:text-white transition text-lg' onClick={onClose}
                    >
                        X
                    </button>
                    ...
                    <div className='relative px-8 pt-14 pb-10 text-center'>
                        ...
                        <h2 className='text-3xl font-semibold leading-tight mb-3 space-x-2'>
                            ...
                            <span className='bg-linear-to-r from-purple-500 to-blue-400 bg-clip-text text-transparent'>GenWeb.ai</span>
                        </h2>

                        <motion.button
                            whileHover={{scale:1.04}}
                            whileTap={{scale:0.96}}
                            onClick={googleAuthenticator}
